...
if "`gprov'" != "" | "`gregio'" != "" | "`macro3'" != "" | "`macro5'" != "" | "`gnuts3'" != "" | "`gnuts2'" != "" | "`gnuts1'" != ""  {
  ...
  if "`gnuts2'" != "" {
    ...
    label define `labnuts2' 1 "ITC1" 2 "ITC2" 7 "ITC3" 3 "ITC4" 41 "ITH1" 42 "ITH2" 5 "ITH3" 6 "ITH4"  8 "ITH5"   ///
    ...
    label var `gnuts2' "NUTS2 2024"
    note `gnuts2': ITC1 Piemonte, ITC2 Valle d’Aosta, ITC3 Liguria, ITC4 Lombardia
    note `gnuts2': ITH1 Provincia Autonoma di Bolzano, ITH2 Provincia Autonoma di Trento, ITH3 Veneto, ITH4 Friuli-Venezia Giulia, ITH5 Emilia-Romagna
    note `gnuts2': ITI1 Toscana, ITI2 Umbria, ITI3 Marche, ITI4 Lazio
    note `gnuts2': ITF1 Abruzzo, ITF2 Molise, ITF3 Campania, ITF4 Puglia, ITF5 Basilicata, ITF6 Calabria
    note `gnuts2': ITG1 Sicilia, ITG2 Sardegna
    drop `gnuts2num'
  }
  ...
  if "`gnuts1'" != "" {
    ...
    label var `gnuts1' "NUTS1 2024"
    note `gnuts1': ITC Nord_Ovest, ITH Nord-Est, ITI Centro, ITF Sud, ITG Isole
    drop `gnuts1num'
  }
}
